...
* @returns {any}
*/
export function init_state(starting_bet, rules) {
    const ret = wasm.init_state(starting_bet, addHeapObject(rules));
...
* @returns {any}
*/
export function next_state(game, action) {
    const ret = wasm.next_state(addHeapObject(game), addHeapObject(action));
    return takeObject(ret);
}
